...
class TwitterController extends Controller
{
    ...
    public function loginAction()
    {
        ...
        {
            return $this->redirect($this->generateUrl($this->container->getParameter('tom32i_user.redirection.login')));
        }
    ...
    private function fail($action, $msg = 'Could not connect to Twitter. Refresh the page or try again later.')
    {
        ...
        switch ($action) 
        {
            ...
            default:
                ...
                return $this->redirect($this->generateUrl($this->container->getParameter('tom32i_user.redirection.' . $action)));
        }
    }
